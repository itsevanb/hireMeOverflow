...
export async function createAnswer(params: CreateAnswerParams) {
  try {
    ...
    // increase authors reputaion by 10 points for creating an answer
...
export async function upvoteAnswer(params: AnswerVoteParams) {
  try {
    ...
    // Increment answer author's reputation by +10/-10 for receiving upvotes/downvote to their answer
